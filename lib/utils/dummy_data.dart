...
List<Reminder> reminders = [
  ...
  Reminder(
      ...
      form: "Tablet(s)",
      imageUrl:
          "https://www.mpulsehealth.com/wp-content/uploads/2020/12/0904-6747-80_Ibuprofen_200mg_Tab_1000.jpg",
      intakes: [
        IntakeData(time: TimeOfDay(hour: 08, minute: 00), dose: 1),
  ...
  Reminder(
      ...
      form: "Liquid",
      imageUrl:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBnAVKSmF85mlUFydDJ2RI4XydwTzJocssUA&s",
      intakes: [
  ...
  Reminder(
      ...
      intakes: [IntakeData(time: TimeOfDay(hour: 08, minute: 30), dose: 1)],
      selectedDays: [0, 6]),
  Reminder(
      id: "5",
  ...
  Reminder(
      ...
      form: "Capsule(s)",
      imageUrl:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT7VsFQruTyfTVVMUd-pSGusGUnLpvzFBhVVw&s",
      intakes: [
  ...
  Reminder(
      ...
      form: "Capsule(s)",
      imageUrl:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgVhFyzZuypIXE1KDO9s2h5HNWO2frC5iDGA&s",
      intakes: [IntakeData(time: TimeOfDay(hour: 08, minute: 00), dose: 1)],
      selectedDays: [0, 6]),
  Reminder(
      id: "10",
      name: "Antacid 20mg",
